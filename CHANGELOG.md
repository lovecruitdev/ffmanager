...
### Changed
- Made auto-updates mandatory on startup, bypassing manual button and toggles for absolute stability.

## [3.4.2] - 2026-07-06

### Changed
- Minor internal improvements and testing of the manual update mechanism.

## [3.4.1] - 2026-07-06

### Fixed
- Fixed manual update race condition by exiting instantly to release the single-instance mutex.
